...
#define wavelength_columnindex 4
#define pulses _p[5]
#define pulses_columnindex 5
#define isi _p[6]
#define isi_columnindex 6
#define pcount _p[7]
#define pcount_columnindex 7
#define on _p[8]
...
extern "C" {
 ...
 static double _hoc_calc_irradiance_photons_flux(void*);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 ostim ostim.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ostim.mod";
static const char* nmodl_file_text = 
