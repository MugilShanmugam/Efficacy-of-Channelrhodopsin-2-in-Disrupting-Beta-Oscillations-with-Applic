...
# here add for loops
import numpy
for exc_mean in numpy.arange(0.05,0.35,0.1):
    for inh_mean in numpy.arange(0.05,0.35,0.1):
        ...
        #"spikeraster" + str(exc_mean) + str(inh_mean) + ".dat"
        # print(exc_mean, inh_mean, latest_spike_network)        
